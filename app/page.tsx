    ...
    <div className="min-h-screen bg-background text-foreground">
      <main>
        <section className="relative isolate min-h-screen overflow-hidden bg-[#111214]">
          ...
          <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1440px] flex-col justify-between gap-12 px-6 pb-12 pt-32 sm:px-10 sm:pb-14 sm:pt-36 lg:flex-row lg:items-end lg:gap-16 lg:px-24 lg:pb-20 lg:pt-40">
